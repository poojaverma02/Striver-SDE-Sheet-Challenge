// T.C: O(N), Each method (inserting a word, counting words equal to a given word, counting words starting with a prefix, and erasing a word)  
// S.C: O(N)
// Question Link: https://takeuforward.org/plus/dsa/problems/trie-implementation-and-advanced-operations?source=strivers-sde-sheet
